...
Other common AI tells include: excessive hedging ("It's important to remember..."), formulaic paragraph openers, over-summarizing at the end of sections, and unnaturally balanced "on the other hand" structures. When in doubt, read your copy aloud - if it sounds like a textbook, rewrite it.
