...
Read ~/.claude/skills/academic-paper/references/anti_leakage_protocol.md
...
Before finalizing the report, run the Writing Quality Check checklist (Read ~/.claude/skills/academic-paper/references/writing_quality_check.md):
...
Read ~/.claude/skills/deep-research/references/apa7_style_guide.md
