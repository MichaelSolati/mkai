...
Reference: `~/.claude/skills/academic-paper/references/anti_leakage_protocol.md`
...
Before finalizing the report, run the Writing Quality Check checklist (see `~/.claude/skills/academic-paper/references/writing_quality_check.md`):
