...
1. Read each sample and extract style dimensions (sentence length variance, hedging frequency, formality register, paragraph density, voice preference)
2. Produce a Style Profile artifact (Schema 10)
