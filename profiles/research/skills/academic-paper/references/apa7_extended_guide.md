...
Extends `~/.mkai/profiles/research/skills/deep-research/references/apa7_style_guide.md` with additional rules specific to full paper writing (vs. research reports).
