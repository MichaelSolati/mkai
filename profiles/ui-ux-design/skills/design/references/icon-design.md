...
python3 ~/.mkai/profiles/ui-ux-design/skills/design/scripts/icon/generate.py --prompt "notification bell" --batch 6 --style outlined --output-dir ./icons
```
...
```bash
python3 ~/.mkai/profiles/ui-ux-design/skills/design/scripts/icon/generate.py --list-styles
python3 ~/.mkai/profiles/ui-ux-design/skills/design/scripts/icon/generate.py --list-categories
```
