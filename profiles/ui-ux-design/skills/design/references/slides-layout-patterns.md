...
python3 ~/.mkai/profiles/ui-ux-design/skills/design-system/scripts/search-slides.py "metrics dashboard" -d layout

# Contextual recommendation
python3 ~/.mkai/profiles/ui-ux-design/skills/design-system/scripts/search-slides.py "traction slide" \
