...
After completing the deviation checks in Phase 4, spawn `qa-lead` via Task using gate **QL-TEST-COVERAGE** (`~/.mkai/profiles/game-dev/skills/help/references/director-gates.md`).
...
Spawn `lead-programmer` via Task using gate **LP-CODE-REVIEW** (`~/.mkai/profiles/game-dev/skills/help/references/director-gates.md`).
