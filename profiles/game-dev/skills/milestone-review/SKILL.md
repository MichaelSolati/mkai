...
Before generating the Go/No-Go recommendation, spawn `producer` via Task using gate **PR-MILESTONE** (`~/.mkai/profiles/game-dev/skills/help/references/director-gates.md`).
